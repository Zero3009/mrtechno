...
<form method="POST" action="/admin/etiquetas/editar/post" accept-charset="UTF-8" class="form-horizontal">
	<div class="row">
                    ...
                    <div class="form-group">
	                    ...
	                    <div class="col-sm-4"> 
	                        <select class="form-control" name="tipo" required="true">
							  <option value="marca" {{ $etiqueta->tipo === 'marca' ? 'selected' : null }}>Marca</option> 
